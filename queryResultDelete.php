...
if(mysql_num_rows($result)==0){
  ...
  $tableTitle = '查詢刪除';
  $formAction = 'deleteMember.php';
  $formOnsubmit = 'return countChecked("刪除");';
  ...
  $tableHead = array($checkAll, '第一次來教會日期', '姓名', '小組', '手機', '電子郵件');
  ...
  for ($i = 0; $i < mysql_num_rows($result); $i++) {
    ...
    $firstCell = "<input type='checkbox' name='memberId[]' value='$row[6]'>";
